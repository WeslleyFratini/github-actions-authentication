...
if(!changelog.edited) {
    warn("Não foram detectadas mudanças no changelog. ")
}
...
if(middlewares.edited) {
    message("É recomendado marcar alguem para fazer o review desta PR, dado que houveram mudanças em arquivos de _middleware_");
}  
